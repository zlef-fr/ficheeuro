...
const T = {
  ...
  lv: { role: "Eiropas Parlamenta deputāts", group: "Grupa", presence: "Līdzdalība balsojumos", participation: "Līdzdalība (nodotie balsojumi)", loyalty: "Lojalitāte grupai", source: "Dati: Eiropas Parlaments (izmantojot HowTheyVote.eu, CC-BY)", homeH1: "Jūsu deputāts skaitļos", homeLead: "Katrs skaitlis nāk no Eiropas Parlamenta oficiālajiem atvērtajiem datiem. Nekādu viedokļu, tikai fakti.", tracked: "Sekotie deputāti", notFoundH1: "Lapa nav atrasta", notFoundLead: "Šī lapa neeksistē. Meklējiet starp %n Eiropas Parlamenta deputātiem.", notFoundCta: "Visi deputāti" },
...
module.exports = { render, notFound, notFoundText, circoLabel };
