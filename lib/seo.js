...
const BASE = "https://eu.fichedepute.fr";
...
const OG_DEFAULT = "https://eu.fichedepute.fr/og.png";
...
function metaFor(pathname) {
  ...
  if (fiche) {
    ...
    if (d) {
      ...
      return {
        title: `${name} (${d.groupe}) — FicheEurodéputé.fr`,
  ...
  const pages = {
    "/deputes": ["Tous les eurodéputés — FicheEurodéputé.fr", "Cherchez et comparez les 719 eurodéputés du Parlement européen (2024-2029) : participation, votes, groupe et circonscription."],
    "/classements": ["Classements des eurodéputés — FicheEurodéputé.fr", "Les plus assidus, les plus absents, les plus actifs, les plus loyaux et les plus frondeurs du Parlement européen."],
    "/groupes": ["Les groupes politiques — FicheEurodéputé.fr", "Participation moyenne et effectifs de chaque groupe politique du Parlement européen."],
    "/jeu": ["Devine l'eurodéputé — FicheEurodéputé.fr", "Le jeu civique : présence + 3 votes POUR et 3 votes CONTRE, à toi de deviner de quelle fiche il s'agit."],
    "/methode": ["Méthode & sources — FicheEurodéputé.fr", "D'où viennent les chiffres de FicheEurodéputé.fr : les jeux open data officiels du Parlement européen (licence Ouverte)."],
  };
  if (pages[p]) return { title: pages[p][0], desc: pages[p][1], canonical: `${BASE}${p}`, og: OG_DEFAULT };
  return { title: "FicheEurodéputé.fr — La fiche vivante de votre eurodéputé·e", desc: SUB, canonical: `${BASE}/`, og: OG_DEFAULT };
}
